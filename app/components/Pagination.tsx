...
export default function Pagination({ children, totalItems, reloadKey, onNewPage }: Props) {
    ...
    }, [pagination.currentPage, pagination.pageSize, reloadKey]);
    ...
    return (
        <div>
            ...
            <div className="flex gap-4 flex-col sm:flex-row justify-center sm:justify-between items-center p-5 rounded-lg bg-bgSecondary border sticky bottom-5 mt-3">
                <p className="text-sm">
                    显示第 {showingItemCountStart}–{showingItemCountEnd} 条，共 {totalItems} 条
                </p>
                <div className="flex gap-1">
                    ...
                    <button className="border rounded-md px-4 py-2 text-sm bg-appPrimary text-white transition-colors">
